...
import { AlertTriangle, Clock, UserX, Eye, EyeOff } from "lucide-react";
      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <label htmlFor="email" className="text-xs font-semibold tracking-wide uppercase text-[hsl(263,40%,52%)] dark:text-[hsl(263,40%,68%)]">
              이메일
            </label>
            <input
              id="email"
              ...
              required
              autoComplete="email"
              className="w-full rounded-xl border border-border bg-muted/40 px-3.5 py-2.5 text-sm text-[hsl(263,50%,32%)] dark:text-[hsl(263,40%,82%)] placeholder:text-muted-foreground/50 outline-none transition-all duration-200 focus:border-primary/60 focus:bg-background focus:ring-2 focus:ring-primary/20 ring-offset-background"
              placeholder="name@example.com"
            />
          </div>

          <div className="space-y-2">
            <label htmlFor="password" className="text-xs font-semibold tracking-wide uppercase text-[hsl(263,40%,52%)] dark:text-[hsl(263,40%,68%)]">
              비밀번호
            </label>
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-border bg-muted/40 px-3.5 py-2.5 pr-10 text-sm text-[hsl(263,50%,32%)] dark:text-[hsl(263,40%,82%)] placeholder:text-muted-foreground/50 outline-none transition-all duration-200 focus:border-primary/60 focus:bg-background focus:ring-2 focus:ring-primary/20 ring-offset-background"
                placeholder="••••••••"
              />
              <button
                type="button"
